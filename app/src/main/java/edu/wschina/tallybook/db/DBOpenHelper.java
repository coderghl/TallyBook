...
public class DBOpenHelper extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase db) {
    String sql = "create table " + DBConstants.TYPE_TB + "(" +
      "id integer primary key autoincrement," +
      "" + DBConstants.TYPE_NAME + " varchar," +
      "" + DBConstants.IMAGE_ID + " integer," +
      "" + DBConstants.SELECT_IMAGE_ID + " integer," +
      "" + DBConstants.KIND + " integer)";

    db.execSQL(sql);

    String sql2 = "create table " + DBConstants.ACCOUNT_TB + "(" +
      "id integer primary key autoincrement," +
      "" + DBConstants.TYPE_NAME + " varchar," +
      "" + DBConstants.SELECT_IMAGE_ID + " integer," +
      "" + DBConstants.REMARK + " varchar," +
      "" + DBConstants.KIND + " integer," +
      "" + DBConstants.YEAR + " integer," +
      "" + DBConstants.MONTH + " integer," +
      "" + DBConstants.DAY + " integer," +
      "" + DBConstants.TIME + " varchar," +
      "" + DBConstants.MONEY + " float)";
  ...
  private void insertType(SQLiteDatabase db) {
    String sql = "insert into " + DBConstants.TYPE_TB + " (" + DBConstants.TYPE_NAME + "," + DBConstants.IMAGE_ID + "," + DBConstants.SELECT_IMAGE_ID + "," + DBConstants.KIND + ") values (?,?,?,?)";
